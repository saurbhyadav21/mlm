...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="{{ route('super-admin.package-settings.index') }}" class="btn btn-outline btn-info btn-sm">@lang('app.freeTrial') @lang('app.menu.settings') <i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
