                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="widget widget-links">
                        ...
                        <ul class="list-no-dividers">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('front.signup.index') }}">@lang('modules.frontCms.getStarted')</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="widget widget-links">
                        ...
                        <ul class="navbar-nav ml-auto">
                            @foreach($footerSettings as $footerSetting)
                                <li class="nav-item active"><a class="nav-link" href="{{ route('front.page', $footerSetting->slug) }}">{{ $footerSetting->name }}</a></li>
                            @endforeach
                                <li class="nav-item">
