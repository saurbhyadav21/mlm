                        ...
                        <tr>
                            ...
                            @foreach($packages as $package)
                                <td class="@if(($package->id == $company->package->id && $company->package_type == 'monthly')) selected-plan @endif">
                                    <h3 class="panel-title price ">{{ $package->currency->currency_symbol }}{{ round($package->monthly_price) }}</h3>
                                </td>
                            @endforeach
                        </tr>
                        ...
                        <tr>
                            ...
                            @foreach($packages as $package)
                                <td class="@if(($package->id == $company->package->id && $company->package_type == 'annual')) selected-plan @endif">
                                    <h3 class="panel-title price">{{ $package->currency->currency_symbol }}{{ round($package->annual_price) }}</h3>
                                </td>
                            @endforeach
                        </tr>
